'use strict';
const BR=[['online','الاونلاين'],['shati','الشاطئ'],['aziziyah','العزيزية'],['fakhriyah','الفاخرية'],['jubail','الجبيل'],['tarout','تاروت'],['hofuf','الهفوف'],['hyper','الهايبر'],['mubarraz','المبرز'],['hafr','حفر الباطن'],['olaya','العليا'],['shahabiyah','الشهابية'],['saihat','سيهات'],['khafji','الخفجي'],['bustan','بستان'],['fursan','الفرسان'],['dahiyah','الضاحية'],['muntazah','المنتزه'],['narjis','النرجس'],['tuwaiq','الطويق'],['dahiyah_laban','الضاحية لبن'],['aziziyah_amwaj','العزيزية الأمواج'],['faaliyah','الفعالية']];
